...
<body onload="window.print()">
    ...
    <div class="certificate-content " style="padding-top: 70px">
        <p>
            ...
            <?php if(isset($patient) && $patient->sex=='M'): ?> M. <?php else: ?> Mme <?php endif; ?> 
...
</html><?php /**PATH C:\Users\user\Documents\CLICK DOC WEB APP\backend-code\backend-final\resources\views/certificat-aptitude.blade.php ENDPATH**/ ?>