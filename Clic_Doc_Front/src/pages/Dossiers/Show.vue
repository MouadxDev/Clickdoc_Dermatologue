...
import { useUiStore } from '../../../core/Data/stores/ui';
    ...
    const liste_motifs = [ 
        ...
        "Autres",
        "Acné",
        "Acrochordons (verrues filiformes)",
        "Albinisme",
        "Allergie cutanée",
        "Angiome",
        "Angiome stellaire",
        ...
        "Dermographisme",
        "Dyschromies (taches pigmentaires)",
        "Eczéma",
        "Érythème noueux",
        "Érythème polymorphe",
        "Érythème solaire",
        ...
        "Chromonychie (coloration anormale des ongles)",
        "Dystrophie unguéale",
        "Hématome sous-unguéal",
        "Hippocratisme digital",
        "Koïlonychie (ongles en cuillère)",
        "Leuconychie (taches blanches sur les ongles)",
        "Lignes de Beau",
        "Mélanonychie (tache brune/noire sur l’ongle)",
        "Mycose des ongles (onychomycose)",
        "Onychatrophie",
        "Onycholyse (décollement de l’ongle)",
        "Onychomadèse (chute soudaine de l’ongle)",
        "Onychophagie (rongement des ongles)",
        "Onychorrhexie (ongles fragiles et cassants)",
        "Pachyonychie",
        "Panaris",
        "Psoriasis unguéal",
        "Trachyonychie (ongles rugueux)Alopécie cicatricielle",
        "Alopécie diffuse",
        "Cheveux cassants",
        "Cheveux gras",
        "Cheveux secs",
        ...
        "Lichen plan pilaire",
        "Mycose du cuir chevelu (teigne du cuir chevelu)",
        "Pityriasis amiantacea",
        "Psoriasis du cuir chevelu",
        "Teigne (dermatophytose du cuir chevelu)",
        "Trichotillomanie",
